...
(function (global, factory) {
  ...
  function getBindingAttr (
    ...
    var dynamicValue =
      ...
      getAndRemoveAttr(el, 'v-bind_' + name);
  ...
  function genDefaultModel (
    ...
    {
      var value$1 = el.attrsMap['v-bind_value'] || el.attrsMap['_value'];
      var typeBinding = el.attrsMap['v-bind_type'] || el.attrsMap['_type'];
      if (value$1 && !typeBinding) {
        var binding = el.attrsMap['v-bind_value'] ? 'v-bind_value' : '_value';
        warn$1(
